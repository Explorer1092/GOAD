...
function Invoke-PostUpdateRemoting {
  $scriptPaths = @(
    (Join-Path -Path $PSScriptRoot -ChildPath "ConfigureRemotingForAnsible.ps1"),
    (Join-Path -Path $PSScriptRoot -ChildPath "enable-winrm.ps1"),
    "A:\ConfigureRemotingForAnsible.ps1",
    "A:\enable-winrm.ps1",
  ...
  LogWrite "No remoting script found; skipping WinRM configuration."
}
